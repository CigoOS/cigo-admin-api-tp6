...
Route::post("/:version/local/upload", ":version.upload/upload"); //本地文件上传
Route::post("/:version/cloud/token", ":version.upload/token"); //获取七牛云凭证
Route::post("/:version/notify/qiniu", ":version.notify/qiniu"); //七牛云异步通知
Route::post("/:version/notify/tencent", ":version.notify/tencent"); //腾讯云异步通知
